...
class EaterNode(Node):
    def __init__(self):
        ...
        self.create_subscription(
            Int64, "pizza_count", self.eat_pizza_count_callback, 10
        )
        ...
        self.create_subscription(
            PoseStamped, "/goal_pose", self.rviz_position_callback, 10
        )
        ...
        self.srv = self.create_service(
            SetParam, "set_eater_kp", self.set_param_callback
        )
    ...
    def rviz_position_callback(self, msg: PoseStamped):
        ...
        self.get_logger().info(
            f"RViz Goal Position: x={msg.pose.position.x + 5.40}, y={msg.pose.position.y + 5.38}"
        )
    ...
    def timer_callback(self):
        ...
        # self.get_logger().info(f"kp_lianear: {self.kp_linear}")
        # self.get_logger().info(f"kp_angular: {self.kp_angular}")
        # self.get_logger().info(f"max_pizza: {self.max_pizza}") 
